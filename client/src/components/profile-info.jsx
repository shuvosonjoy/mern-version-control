...
const ProfileInfo = ({userProfile}) => {
	...
	// 	followers: 100,
	// 	following: 200,
	// 	html_url: "https://github.com/shuvosonjoy",
	...
	return (
		<div className='lg:w-1/3 w-full flex flex-col gap-2 lg:sticky md:top-10'>
			<div className='bg-glass border border-gray-700 rounded-lg p-4'>
				<div className='flex gap-4 items-center'>
					...
					<div className='flex gap-2 items-center flex-col'>
						<a
							...
							target='_blank'
							rel='noreferrer'
							className='bg-glass font-medium w-full text-xs p-2 rounded-md cursor-pointer border flex items-center gap-2'
						>
							<FaEye size={16} className="text-green-400" />
							View on Github
						</a>
					</div>
				</div>
			...
			<div className='flex flex-wrap gap-2 mx-4'>
				...
				<div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1 min-w-24'>
					<RiUserFollowFill className='w-5 h-5 text-green-700' />
					<p className='text-xs'>Followers: {userProfile?.followers}</p>
				</div>

				{/* Following count */}
				<div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1 min-w-24'>
					<RiUserFollowLine className='w-5 h-5 text-green-700' />
					<p className='text-xs'>Following: {userProfile?.following}</p>
				</div>

				{/* Number of public repos */}
				<div className='flex items-center gap-2 bg-glass rounded-lg p-2 flex-1 min-w-24'>
					<RiGitRepositoryFill className='w-5 h-5 text-green-700' />
